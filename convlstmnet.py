...
class ConvLSTMNet(nn.Module):
    def __init__(self,
        ...
        kernel_size = 3, bias = True, dropout = 0.1,
        ...
        self.layers["drop_out"] = nn.Dropout(dropout)
        self.layers["output"] = nn.Conv1d(channels, 1, 
   ...
   #     self.final_layer=nn.Linear(input_signal_width,self.output_dim)
    ...
    def forward(self, inputs, input_frames=20, future_frames=1, output_frames=1,channels=1, 
        ...
        batch_size, input_frames, channels = inputs.size()
        height=1
        ...
        for t in range(total_steps):
            ...
            input_ = self.layers["drop_out"](input_)
